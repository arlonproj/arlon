...
Below is an example of an manifest file with which we can create a *base cluster*. This manifest file helps in 
deploying an EKS cluster with machine deployment component.
