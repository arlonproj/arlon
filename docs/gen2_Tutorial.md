...
Preparing the git directory to serve as the bascluster: 
...
To create a gen2 workload with a cluster-autoscaler pod running, from the base cluster, run this command:
