...
require (
	github.com/argoproj/argo-cd/v2 v2.2.15
...
require (
	...
	k8s.io/cli-runtime v0.22.15 // indirect
...
replace (
	github.com/ProtonMail/go-crypto => github.com/ProtonMail/go-crypto v0.0.0-20221026131551-cf6655e29de4
