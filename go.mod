...
require (
	...
	sigs.k8s.io/cluster-api v1.5.2 //v1.1.x will upgrade k8s APIs to v0.23.x
	sigs.k8s.io/controller-runtime v0.15.1 //v1.13 will upgrade k8s APIs to v0.25.x
)
...
require (
	...
	sigs.k8s.io/cluster-api-provider-aws/v2 v2.2.3
